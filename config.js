// StickyBoard configuration.
// Edit this file once and all three pages (index.html, Submit.html, Admin.html)
// will pick up the same Apps Script Web App URL.
//
// 1. In Apps Script, click Deploy > Manage deployments and copy the Web App URL.
